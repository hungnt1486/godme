...
extension String {
    ...
    func numberFormat(str: String) -> String {
        ...
        amountWithPrefix = regex.stringByReplacingMatches(in: amountWithPrefix, options: NSRegularExpression.MatchingOptions(rawValue: 0), range: NSMakeRange(0, str.count), withTemplate: "")
    ...
    func currencyInputFormatting(str: String) -> (String, String) {
...
//        formatter.minimumFractionDigits = 2
        ...
        return (formatter.string(from: number)!, amountWithPrefix)
    }
}
